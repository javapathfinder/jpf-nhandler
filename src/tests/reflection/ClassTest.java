...
public class ClassTest<E> extends TestJPF {
  ...
  // assertEquals((new Object[0]).getClass().getCanonicalName(),
  // "java.lang.Object[]");
  // }
  // // }
  //
  ...
  // if (verifyNoPropertyViolation(JPF_ARGS)){
  // assertTrue(ClassTest.ParentAnnotated.class.getDeclaredAnnotations().length
  // == 1);
  ...
  // // testing Constructor
  // @Test
  // public void getEnclosingConstructor () throws SecurityException,
  // NoSuchMethodException{
  // if (verifyNoPropertyViolation(JPF_ARGS)){
  // // // System.out.println(TestEnclosedClass.class.getConstructor());
  ...
  // // // assertTrue(cls.getEnclosingConstructor().getDeclaringClass() ==
  ...
  // @Test
  // public void getEnclosingMethod () throws SecurityException,
  // NoSuchMethodException {
  // if (verifyNoPropertyViolation(JPF_ARGS)) {
  // System.out.println(TestEnclosedClass.class.getMethods());
  // Class cls = (new
  // ClassTest.TestEnclosedClass()).getLocalClassObj().getClass();
  // // assertTrue(cls.getEnclosingMethod().getDeclaringClass() ==
  // // ClassTest.TestEnclosedClass.class);
  // System.out.println("**" + cls.getEnclosingMethod().getDeclaringClass() +
  // " == " + ClassTest.TestEnclosedClass.class);
  ...
  // assertEquals(pd.getCodeSource().getLocation(),
  // ClassTest.TestEnclosedClass.class.getProtectionDomain().getCodeSource().getLocation());
  // }
  // }
  //
  // @Test
  ...
  // if (verifyNoPropertyViolation(JPF_ARGS)) {
  // Class cls = (new
  // ClassTest.TestEnclosedClass()).getAnonymousClassObj().getClass();
